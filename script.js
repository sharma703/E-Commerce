...
const BANNERS = [
  ...
  },
  {
    ...
    subtitle: "The hottest products of 2025 — be the first to own them!",
...
const PRODUCTS = [
  ...
  {
    id: "p23",
    name: "OnePlus 13 5G (256 GB, Midnight Ocean)",
    category: "electronics",
    price: 69999,
    mrp: 79999,
    discount: 13,
    ...
    badge: "new",
    description: "The OnePlus 13 5G features the powerful Snapdragon 8 Elite chip, a 6000 mAh battery, and a stunning triple Hasselblad camera at the back — all in a premium glass-metal design.",
    features: ["Snapdragon 8 Elite Processor", "50 MP Hasselblad Triple Camera", "6000 mAh Battery + 100W Charging", "6.82-inch LTPO AMOLED 120Hz Display"],
    stock: "In Stock",
    tags: ["new-launch", "recommended"],
  },
  {
    id: "p24",
    name: "Samsung Galaxy S25 Ultra (512 GB, Titanium Black)",
    category: "electronics",
    price: 129999,
    mrp: 144999,
    discount: 10,
    ...
    badge: "new",
    description: "The Galaxy S25 Ultra redefines mobile AI with the built-in S Pen, Galaxy AI features, and a 200 MP camera. Powered by Snapdragon 8 Elite for Galaxy.",
    features: ["Snapdragon 8 Elite for Galaxy", "200 MP Pro-Grade Camera System", "Built-in S Pen with AI Features", "5000 mAh Battery + 45W Wired Charging"],
    stock: "In Stock",
    tags: ["new-launch", "bestseller"],
  },
  {
    id: "p25",
    name: "Apple MacBook Air M3 (13-inch, 16 GB RAM, 512 GB SSD)",
    category: "electronics",
    price: 134900,
    mrp: 149900,
    discount: 10,
    ...
    badge: "new",
    description: "The MacBook Air with M3 chip delivers up to 18 hours of battery life, blazing-fast performance, and a gorgeous Liquid Retina display. The world's best thin-and-light laptop.",
    features: ["Apple M3 Chip (8-core CPU, 10-core GPU)", "16 GB Unified Memory", "13.6-inch Liquid Retina Display", "18-Hour Battery Life | 1.24 kg"],
    stock: "In Stock",
    tags: ["new-launch", "recommended"],
  },
  {
    ...
    badge: "new",
    description: "The PS5 Slim is 30% smaller than the original PS5, delivers 4K gaming at up to 120fps, and includes the DualSense wireless controller with haptic feedback.",
    features: ["4K Gaming at up to 120fps", "DualSense Controller with Haptic Feedback", "1 TB Ultra-High Speed SSD", "30% Smaller than Original PS5"],
    stock: "Only 5 left",
    tags: ["new-launch", "deal"],
  },
  {
    id: "p27",
    name: "Realme GT 7 Pro 5G (256 GB, Mars Orange)",
    category: "electronics",
    price: 41999,
    mrp: 49999,
    discount: 16,
    ...
    badge: "new",
    description: "Realme GT 7 Pro brings the Snapdragon 8 Elite experience at a competitive price with a 6500 mAh battery, 120W charging, and a flagship-grade periscope camera.",
    features: ["Snapdragon 8 Elite Chipset", "50 MP Periscope Telephoto Camera", "6500 mAh Battery + 120W Charging", "6.78-inch AMOLED 144Hz Display"],
    stock: "In Stock",
    tags: ["new-launch", "deal"],
  },
  {
    id: "p28",
    name: "Noise ColorFit Ultra 3 Smartwatch (46mm)",
    category: "electronics",
    price: 3499,
    mrp: 8999,
    discount: 61,
    ...
    badge: "hot",
    description: "The Noise ColorFit Ultra 3 features a large 1.96-inch AMOLED display, 100+ sports modes, Bluetooth calling, and 7-day battery life in a sleek unibody metal design.",
    features: ["1.96-inch AMOLED Always-On Display", "Bluetooth Calling + Built-in Mic & Speaker", "100+ Sports Modes | 7-Day Battery", "IP68 Water Resistance"],
    stock: "In Stock",
    tags: ["new-launch", "bestseller", "deal"],
  },
  {
    id: "p29",
    name: "boAt Wave Alpha Smartwatch with AMOLED Display",
    category: "electronics",
    price: 1999,
    mrp: 5999,
    discount: 67,
    ...
    badge: "deal",
    description: "boAt Wave Alpha features a vivid AMOLED display, stress monitor, SpO2 tracking, and 5 days of battery life. Built for those who want premium features at a budget price.",
    features: ["1.43-inch AMOLED Display", "Heart Rate + SpO2 Monitor", "5-Day Battery Life", "105+ Sport Modes | BT v5.0"],
    stock: "In Stock",
    tags: ["new-launch", "deal"],
  },
  {
    id: "p30",
    name: "Levi's Men's Slim Fit Graphic Tee – 2025 Edition",
    category: "fashion",
    price: 799,
    mrp: 1499,
    discount: 47,
    ...
    badge: "new",
    description: "All-new 2025 graphic tee from Levi's featuring a vintage-inspired print on premium 100% cotton. Slim fit, breathable and ideal for casual wear or layering.",
    features: ["100% Premium Cotton", "Slim Fit | Machine Washable", "Vintage Graphic Print", "Available in S, M, L, XL, XXL"],
    stock: "In Stock",
    tags: ["new-launch", "deal"],
  },
  {
    id: "p31",
    name: "Adidas Ultraboost 5.0 DNA Running Shoes",
    category: "fashion",
    price: 11999,
    mrp: 18999,
    discount: 37,
    ...
    badge: "new",
    description: "The Adidas Ultraboost 5.0 DNA delivers an energy-returning BOOST midsole, Primeknit+ upper, and Continental rubber outsole for an unparalleled running sensation.",
    features: ["BOOST Midsole for Energy Return", "Primeknit+ Adaptive Upper", "Continental Rubber Outsole", "Available in 8 Colorways"],
    stock: "In Stock",
    tags: ["new-launch", "recommended"],
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=400&fit=crop&auto=format",
    badge: "new",
    description: "The Dyson V15 Detect uses laser technology to reveal hidden microscopic dust. With up to 60 minutes of run time and HEPA filtration, it captures 99.99% of particles.",
    features: ["Laser Dust Detection Technology", "Up to 60 Min Cordless Runtime", "HEPA Filtration – captures 99.99% particles", "LCD Screen with Real-time Performance Data"],
    stock: "In Stock",
    tags: ["new-launch", "recommended"],
  },
  {
    id: "p33",
    name: "Instant Pot Pro 10-in-1 Multi-Cooker (5.7 L)",
    category: "home",
    price: 9999,
    mrp: 15999,
    discount: 38,
    ...
    image: "https://images.unsplash.com/photo-1585515320310-259814833e62?w=400&h=400&fit=crop&auto=format",
    badge: "new",
    description: "Instant Pot Pro replaces 10 kitchen appliances — pressure cooker, slow cooker, rice cooker, steamer, sauté pan and more. Built-in programmes for perfectly cooked meals every time.",
    features: ["10-in-1 Multifunctional Kitchen Appliance", "5.7 L Stainless Steel Inner Pot", "Smart Programs + Customisable Settings", "UL Certified Safety with 11 Safety Mechanisms"],
    stock: "In Stock",
    tags: ["new-launch", "deal"],
  },
  {
    ...
    badge: "new",
    description: "A timeless tale of self-discovery and following your dreams. This anniversary edition includes a special introduction by Paulo Coelho and exclusive artwork.",
    features: ["Anniversary Edition with Bonus Content", "Paperback – 208 pages", "Publisher: HarperOne", "Over 65 Million Copies Sold Worldwide"],
    stock: "In Stock",
    tags: ["new-launch", "bestseller", "recommended"],
  },
  {
    id: "p35",
    name: "Kosher Cosmetics BB Tinted Sunscreen SPF 50+",
    category: "beauty",
    price: 599,
    mrp: 999,
    discount: 40,
    ...
    badge: "new",
    description: "A lightweight tinted sunscreen that combines BB cream coverage with SPF 50+ sun protection. Hydrates, blurs pores, and suits all Indian skin tones.",
    features: ["SPF 50+ + PA++++ Broad Spectrum", "BB Cream Tint for Natural Coverage", "Lightweight, Non-Greasy Formula", "Suitable for All Skin Types | 50 ml"],
    stock: "In Stock",
    tags: ["new-launch", "deal", "recommended"],
  },
  {
    id: "p36",
    name: "Boldfit Adjustable Dumbbell Set (2–24 kg, 15 Levels)",
    category: "sports",
    price: 7999,
    mrp: 14999,
    discount: 47,
    ...
    badge: "new",
    description: "Replace 15 pairs of dumbbells with a single adjustable set! The Boldfit Adjustable Dumbbell adjusts from 2 to 24 kg in 1.6 kg increments using a quick-turn dial.",
    features: ["Adjustable 2–24 kg in 15 Levels", "Quick-Turn Dial for Fast Adjustment", "Replaces 15 Sets of Dumbbells", "Anti-Roll Design | 1-Year Warranty"],
    stock: "In Stock",
    tags: ["new-launch", "recommended"],
  },
  {
    id: "p37",
    name: "Hot Wheels Ultimate Garage Playset 2025 Edition",
    category: "toys",
    price: 4999,
    mrp: 7999,
    discount: 38,
    ...
    image: "https://images.unsplash.com/photo-1594736797933-d0501ba2fe65?w=400&h=400&fit=crop&auto=format",
    badge: "new",
    description: "The all-new 2025 Ultimate Garage Playset includes a car wash, elevator, jumps, and space for 140+ Hot Wheels cars. Includes 1 exclusive die-cast car.",
    features: ["Stores 140+ Hot Wheels Cars", "Working Elevator & Car Wash", "Includes 1 Exclusive Die-Cast Car", "Ages 4+ | Easy Assembly"],
    stock: "In Stock",
    tags: ["new-launch", "recommended"],
  },
];
...
function renderHome() {
  ...
  // New Arrivals (recently launched)
...
function filterByCategory(catKey) {
  ...
  if (catKey === "new-launch") {
    results = PRODUCTS.filter(p => p.tags.includes("new-launch"));
    label = "🚀 New Arrivals 2025";
  } else if (catKey === "deals") {
    results = PRODUCTS.filter(p => p.tags.includes("deal"));
    label = "Today's Deals";
  } else if (catKey === "all") {
    clearSearch();
    ...
    results = PRODUCTS.filter(p => p.category === catKey);
    label = CATEGORIES.find(c => c.key === catKey)?.name || catKey;
  }
...
const AUTH_KEY  = "megacart_user_v1";   // current logged-in user session
const USERS_KEY = "megacart_users_v1";  // all registered users list
...
function updateAuthUI() {
  ...
  // ─ Mobile menu first link: reflects auth state ─
  const mobileAuthLink = document.getElementById("mobileAuthLink");
  if (mobileAuthLink) {
    if (user) {
      mobileAuthLink.innerHTML = `<i class="bi bi-person-circle me-2"></i>Hello, ${user.name.split(" ")[0]}`;
      mobileAuthLink.style.color = "var(--mc-orange)";
      mobileAuthLink.href = "#";
      mobileAuthLink.onclick = (e) => { e.preventDefault(); };
    } else {
      mobileAuthLink.innerHTML = `<i class="bi bi-person-circle me-2"></i>Sign In / Create Account`;
  ...
  // ─ Navbar logout button (upper right) ─
...
function handleRegister(e) {
  ...
  // Email validation
  if (!email) {
    setFieldError("regEmail", null, "regEmailError", "Enter your email address.");
    valid = false;
  } else if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) {
    setFieldError("regEmail", null, "regEmailError", "Enter a valid email address.");
    valid = false;
  }
  // Phone validation
  if (!phone) {
    setFieldError("regPhone", null, "regPhoneError", "Enter your 10-digit mobile number.");
    valid = false;
  } else if (!/^[6-9]\d{9}$/.test(phone)) {
    setFieldError("regPhone", null, "regPhoneError", "Enter a valid 10-digit Indian mobile number.");
    valid = false;
  }
  // Password validation
  ...
  // ── Duplicate checks (the "database" layer) ──────
  const users = JSON.parse(localStorage.getItem(USERS_KEY) || "[]");

  if (users.find(u => u.email && u.email.toLowerCase() === email)) {
    setFieldError("regEmail", null, "regEmailError", "⚠ An account with this email already exists. Please sign in.");
    return;
  }
  if (users.find(u => u.phone && u.phone === phone)) {
    setFieldError("regPhone", null, "regPhoneError", "⚠ This mobile number is already registered. Please sign in.");
    return;
  }
